...
example, if the work day is 08:00-17:00, the lenth of the day is 9
...
L<"ADDITONAL DELTA NOTATIONS"> section.
...
By default, a delta is normalized, but setting the B<nonrom> key to
