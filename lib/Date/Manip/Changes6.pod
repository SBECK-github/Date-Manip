...
=head1 VERSION 6.70 (planned 2018-03-01)
...
were replaced with non-intutitive numerical calculations that gave the same
result faster.
...
Fixed a typo in the Holidays man page.  Kim Border.
